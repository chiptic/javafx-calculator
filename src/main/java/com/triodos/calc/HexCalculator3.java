...
public class HexCalculator3 extends Application {
  ...
  public void start(Stage primaryStage) throws Exception {
    FXMLLoader loader = new FXMLLoader(getClass().getResource("hexcalculator3.fxml"));
    ...
    scene.getStylesheets().add(getClass().getResource("hexcalculator3.css").toExternalForm());

    primaryStage.setTitle("JavaFX HexCalc3");
