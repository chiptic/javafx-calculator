...
public class HexCalculator2 extends Application {
  ...
  public void start(Stage primaryStage) throws Exception {
    FXMLLoader loader = new FXMLLoader(getClass().getResource("hexcalculator2.fxml"));
    ...
    scene.getStylesheets().add(getClass().getResource("hexcalculator2.css").toExternalForm());

    primaryStage.setTitle("JavaFX HexCalc2");
